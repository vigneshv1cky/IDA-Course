---
title: "Group 5 HW 4"
author: "Vignesh Murugan and Tyler Brassfield"
date: "2024-09-22"
output: pdf_document
---
...
housingData <- tibble(read_csv("housingData.csv"))
...
Note: R does not have functions for identifying the frequencies of the first, second, or least commmon
...
FactorSummary <-cbind(
  stat=c("n","unique","missing","most_common","most_common_count","2nd_most_common","2nd_most_common_count",
